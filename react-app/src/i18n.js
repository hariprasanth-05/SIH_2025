...
const resources = {
  en: {
    translation: {
      ...
      upvote: "Upvote",
      reply: "Reply",
      aiGreeting: "Namaste! I am Pashurakshak. How can I assist you? You can type or click the microphone to speak."
    }
  },
  ta: {
    translation: {
      ...
      upvote: "மேல்வாக்கு",
      reply: "பதில்",
      aiGreeting: "வணக்கம்! நான் பஷுரக்ஷக். நான் உங்களுக்கு எப்படி உதவ முடியும்? நீங்கள் தட்டச்சு செய்யலாம் அல்லது பேச மைக்ரோஃபோனைக் கிளிக் செய்யலாம்.", // <-- Add this line
  ...
  te: {
    translation: {
      ...
      hello: "హలో! నేను మీ ఫార్మింగ్ బడ్డీ. ఈ రోజు మీకు ఎలా సహాయం చేయగలను?",
      ...
      upvote: "అప్ ఓటు",
      reply: "సమాధానం",
aiGreeting: "నమస్కారం! నేను పశురక్షక్. నేను మీకు ఎలా సహాయపడగలను? మీరు టైప్ చేయవచ్చు లేదా మాట్లాడటానికి మైక్రోఫోన్‌ను క్లిక్ చేయవచ్చు."
    }
  },
  ml: {
    translation: {
      ...
      upvote: "അപ്‌വോട്ട്",
      reply: "മറുപടി",
aiGreeting: "നമസ്കാരം! ഞാൻ പശുരക്ഷക് ആണ്. ഞാൻ നിങ്ങളെ എങ്ങനെ സഹായിക്കും? നിങ്ങൾക്ക് ടൈപ്പ് ചെയ്യാം അല്ലെങ്കിൽ സംസാരിക്കാൻ മൈക്രോഫോണിൽ ക്ലിക്ക് ചെയ്യാം."
    }
  },
  kn: {
    translation: {
      ...
      upvote: "ಅಪ್‌ವೋಟ್",
      reply: "ಪ್ರತ್ಯುತ್ತರ",
  aiGreeting: "ನಮಸ್ಕಾರ! ನಾನು ಪಶುರಕ್ಷಕ. ನಾನು ನಿಮಗೆ ಹೇಗೆ ಸಹಾಯ ಮಾಡಬಹುದು? ನೀವು ಟೈಪ್ ಮಾಡಬಹುದು ಅಥವಾ ಮಾತನಾಡಲು ಮೈಕ್ರೊಫೋನ್ ಕ್ಲಿಕ್ ಮಾಡಬಹುದು."
    }
  },
  hi: {
    translation: {
      welcome: "वापसी पर स्वागत है, किसान!",
      monitor: "अपने खेत के स्वास्थ्य और उत्पादकता की निगरानी करें",
      digitalTwin: "डिजिटल ट्विन फार्म",
      realTime: "वास्तविक समय में खेत की निगरानी और विश्लेषण",
      livestockHealth: "पशुधन स्वास्थ्य",
      cropStatus: "फसल की स्थिति",
      dailyScan: "दैनिक स्कैन",
      uploadPhotos: "एआई स्वास्थ्य विश्लेषण के लिए तस्वीरें अपलोड करें",
      startScan: "स्कैन शुरू करें",
      activeAlerts: "सक्रिय अलर्ट",
      viewDetails: "विवरण देखें",
      diseaseOutbreak: "रोग का प्रकोप",
      vaccinationDue: "टीकाकरण देय",
      allSystemsNormal: "सभी प्रणालियाँ सामान्य हैं",
      diseaseCheck: "रोग जांच 🔬",
      aiPowered: "एआई-संचालित रोग का पता लगाना और निदान",
      uploadMedia: "मीडिया अपलोड करें",
      uploadPhoto: "फोटो अपलोड करें",
      takePhoto: "प्रभावित जानवर/फसल की स्पष्ट तस्वीर लें",
      choosePhoto: "फोटो चुनें",
      uploadVideo: "वीडियो अपलोड करें",
      recordVideo: "जानवर के व्यवहार या लक्षणों को रिकॉर्ड करें",
      recordVideoBtn: "वीडियो रिकॉर्ड करें",
      voiceSymptoms: "आवाज से लक्षण बताएं",
      describeSymptoms: "अपनी भाषा में लक्षण बताएं",
      startRecording: "रिकॉर्डिंग शुरू करें",
      aiDiagnosis: "एआई निदान",
      preventiveSteps: "निवारक कदम:",
      isolate: "प्रभावित जानवरों को तुरंत अलग करें",
      disinfect: "चारे के क्षेत्रों को कीटाणुरहित करें",
      contactVet: "पशु चिकित्सक से संपर्क करें",
      monitorAnimals: "अन्य जानवरों की बारीकी से निगरानी करें",
      chatVet: "पशु चिकित्सक के साथ चैट करें",
      askFarmers: "साथी किसानों से पूछें",
      outbreakMap: "प्रकोप का नक्शा 🗺️",
      realTimeOutbreak: "आपके क्षेत्र में वास्तविक समय में रोग के प्रकोप की निगरानी",
      farmRecords: "खेत के रिकॉर्ड 📋",
      digitalDiary: "आपके खेत की गतिविधियों के लिए डिजिटल डायरी",
      vaccination: "टीकाकरण",
      treatment: "इलाज",
      hygiene: "स्वच्छता और सफाई स्कैनर 🧽",
      hygieneAssessment: "एआई-संचालित स्वच्छता मूल्यांकन और सिफारिशें",
      cameraScanner: "कैमरा स्कैनर",
      pointCamera: "पानी की टंकियों, चारे के क्षेत्रों या पशु आश्रयों पर कैमरा इंगित करें",
      recommendations: "सिफारिशें",
      cleanWater: "पानी की टंकी साफ करें",
      disinfectShed: "शेड को कीटाणुरहित करें",
      pestControl: "कीट नियंत्रण",
      buddyAI: "किसान बडी एआई 🤖",
      farmingAssistant: "आपका बुद्धिमान खेती सहायक",
      voiceAssistant: "आवाज सहायक",
      tapSpeak: "बोलने के लिए टाइप करें या माइक पर क्लिक करें...",
      quickActions: "त्वरित कार्य",
      aiDailyBriefing: "एआई दैनिक ब्रीफिंग",
      weatherOutlook: "मौसम का पूर्वानुमान",
      productivityInsight: "उत्पादकता अंतर्दृष्टि",
      priorityTask: "प्राथमिकता कार्य",
      community: "समुदाय",
      home: "होम",
      aiGreeting: "नमस्ते! मैं पशु-रक्षक हूँ। मैं आपकी कैसे सहायता कर सकता हूँ? आप टाइप कर सकते हैं या बोलने के लिए माइक्रोफ़ोन पर क्लिक कर सकते हैं।",
    }
  },
  mr: {
    translation: {
      welcome: "पुन्हा स्वागत आहे, शेतकरी!",
      monitor: "तुमच्या शेताच्या आरोग्यावर आणि उत्पादकतेवर लक्ष ठेवा",
      digitalTwin: "डिजिटल ट्विन फार्म",
      realTime: "रिअल-टाइम फार्म मॉनिटरिंग आणि विश्लेषण",
      livestockHealth: "पशुधन आरोग्य",
      cropStatus: "पीक स्थिती",
      dailyScan: "दैनिक स्कॅन",
      uploadPhotos: "एआय आरोग्य विश्लेषणासाठी फोटो अपलोड करा",
      startScan: "स्कॅन सुरू करा",
      activeAlerts: "सक्रिय सूचना",
      viewDetails: "तपशील पहा",
      diseaseOutbreak: "रोगाचा प्रादुर्भाव",
      vaccinationDue: "लसीकरण देय आहे",
      allSystemsNormal: "सर्व प्रणाली सामान्य आहेत",
      diseaseCheck: "रोग तपासणी 🔬",
      aiPowered: "एआय-चालित रोग ओळख आणि निदान",
      uploadMedia: "मीडिया अपलोड करा",
      uploadPhoto: "फोटो अपलोड करा",
      takePhoto: "बाधित प्राणी/पिकाचा स्पष्ट फोटो घ्या",
      choosePhoto: "फोटो निवडा",
      uploadVideo: "व्हिडिओ अपलोड करा",
      recordVideo: "प्राण्याचे वर्तन किंवा लक्षणे रेकॉर्ड करा",
      recordVideoBtn: "व्हिडिओ रेकॉर्ड करा",
      voiceSymptoms: "आवाजाद्वारे लक्षणे सांगा",
      describeSymptoms: "तुमच्या भाषेत लक्षणे सांगा",
      startRecording: "रेकॉर्डिंग सुरू करा",
      aiDiagnosis: "एआय निदान",
      preventiveSteps: "प्रतिबंधात्मक उपाय:",
      isolate: "बाधित प्राण्यांना त्वरित वेगळे करा",
      disinfect: "खाद्य क्षेत्र निर्जंतुक करा",
      contactVet: "पशुवैद्यकाशी संपर्क साधा",
      monitorAnimals: "इतर प्राण्यांवर बारकाईने लक्ष ठेवा",
      chatVet: "पशुवैद्यकाशी गप्पा मारा",
      askFarmers: "सहकारी शेतकऱ्यांना विचारा",
      outbreakMap: "प्रकोप नकाशा 🗺️",
      realTimeOutbreak: "तुमच्या परिसरातील रोगाच्या प्रादुर्भावावर रिअल-टाइम लक्ष ठेवा",
      farmRecords: "शेती रेकॉर्ड 📋",
      digitalDiary: "तुमच्या शेतातील कामांसाठी डिजिटल डायरी",
      vaccination: "लसीकरण",
      treatment: "उपचार",
      hygiene: "स्वच्छता आणि आरोग्य स्कॅनर 🧽",
      hygieneAssessment: "एआय-चालित स्वच्छता मूल्यांकन आणि शिफारसी",
      cameraScanner: "कॅमेरा स्कॅनर",
      pointCamera: "पाण्याच्या टाक्या, खाद्य क्षेत्र किंवा पशुधन निवाऱ्यांवर कॅमेरा लावा",
      recommendations: "शिफारसी",
      cleanWater: "पाण्याची टाकी स्वच्छ करा",
      disinfectShed: "शेड निर्जंतुक करा",
      pestControl: "कीटक नियंत्रण",
      buddyAI: "शेतकरी बडी एआय 🤖",
      farmingAssistant: "तुमचा बुद्धिमान शेती सहायक",
      voiceAssistant: "आवाज सहायक",
      tapSpeak: "बोलण्यासाठी टाइप करा किंवा माइकवर क्लिक करा...",
      quickActions: "त्वरित कृती",
      aiDailyBriefing: "एआय दैनिक माहिती",
      weatherOutlook: "हवामान अंदाज",
      productivityInsight: "उत्पादकता माहिती",
      priorityTask: "प्राधान्य कार्य",
      community: "समुदाय",
      home: "होम",
      aiGreeting: "नमस्कार! मी पशु-रक्षक आहे. मी तुमची कशी मदत करू शकेन? तुम्ही टाइप करू शकता किंवा बोलण्यासाठी मायक्रोफोनवर क्लिक करू शकता.",
    }
  },
  or: {
    translation: {
      welcome: "ପୁଣି ସ୍ୱାଗତ, କୃଷକ!",
      monitor: "ଆପଣଙ୍କ ଫାର୍ମର ସ୍ୱାସ୍ଥ୍ୟ ଏବଂ ଉତ୍ପାଦକତା ଉପରେ ନଜର ରଖନ୍ତୁ",
      digitalTwin: "ଡିଜିଟାଲ୍ ଟ୍ୱିନ୍ ଫାର୍ମ",
      realTime: "ବାସ୍ତବ ସମୟରେ ଫାର୍ମ ମନିଟରିଂ ଏବଂ ବିଶ୍ଳେଷଣ",
      livestockHealth: "ପଶୁପାଳନ ସ୍ୱାସ୍ଥ୍ୟ",
      cropStatus: "ଫସଲ ସ୍ଥିତି",
      dailyScan: "ଦୈନିକ ସ୍କାନ୍",
      uploadPhotos: "AI ସ୍ୱାସ୍ଥ୍ୟ ବିଶ୍ଳେଷଣ ପାଇଁ ଫଟୋ ଅପଲୋଡ୍ କରନ୍ତୁ",
      startScan: "ସ୍କାନ୍ ଆରମ୍ଭ କରନ୍ତୁ",
      activeAlerts: "ସକ୍ରିୟ ସତର୍କତା",
      viewDetails: "ବିବରଣୀ ଦେଖନ୍ତୁ",
      diseaseOutbreak: "ରୋଗର ପ୍ରାଦୁର୍ଭାବ",
      vaccinationDue: "ଟୀକାକରଣ ବାକି ଅଛି",
      allSystemsNormal: "ସମସ୍ତ ସିଷ୍ଟମ୍ ସାଧାରଣ ଅଛି",
      diseaseCheck: "ରୋଗ ଯାଞ୍ଚ 🔬",
      aiPowered: "AI-ଚାଳିତ ରୋଗ ଚିହ୍ନଟ ଏବଂ ନିଦାନ",
      uploadMedia: "ମିଡିଆ ଅପଲୋଡ୍ କରନ୍ତୁ",
      uploadPhoto: "ଫଟୋ ଅପଲୋଡ୍ କରନ୍ତୁ",
      takePhoto: "ପ୍ରଭାବିତ ପଶୁ/ଫସଲର ସ୍ପଷ୍ଟ ଫଟୋ ନିଅନ୍ତୁ",
      choosePhoto: "ଫଟୋ ବାଛନ୍ତୁ",
      uploadVideo: "ଭିଡିଓ ଅପଲୋଡ୍ କରନ୍ତୁ",
      recordVideo: "ପଶୁର ଆଚରଣ କିମ୍ବା ଲକ୍ଷଣ ରେକର୍ଡ କରନ୍ତୁ",
      recordVideoBtn: "ଭିଡିଓ ରେକର୍ଡ କରନ୍ତୁ",
      voiceSymptoms: "ଭଏସ୍ ଦ୍ୱାରା ଲକ୍ଷଣ କୁହନ୍ତୁ",
      describeSymptoms: "ଆପଣଙ୍କ ଭାଷାରେ ଲକ୍ଷଣ ବର୍ଣ୍ଣନା କରନ୍ତୁ",
      startRecording: "ରେକର୍ଡିଂ ଆରମ୍ଭ କରନ୍ତୁ",
      aiDiagnosis: "AI ନିଦାନ",
      preventiveSteps: "ପ୍ରତିଷେଧକ ପଦକ୍ଷେପ:",
      isolate: "ପ୍ରଭାବିତ ପଶୁମାନଙ୍କୁ ତୁରନ୍ତ ଅଲଗା କରନ୍ତୁ",
      disinfect: "ଖାଇବା ସ୍ଥାନକୁ ବିଶୋଧନ କରନ୍ତୁ",
      contactVet: "ପଶୁ ଚିକିତ୍ସକଙ୍କ ସହିତ ଯୋଗାଯୋଗ କରନ୍ତୁ",
      monitorAnimals: "ଅନ୍ୟ ପଶୁମାନଙ୍କ ଉପରେ ନଜର ରଖନ୍ତୁ",
      chatVet: "ପଶୁ ଚିକିତ୍ସକଙ୍କ ସହିତ ଚାଟ୍ କରନ୍ତୁ",
      askFarmers: "ସାଥୀ କୃଷକମାନଙ୍କୁ ପଚାରନ୍ତୁ",
      outbreakMap: "ପ୍ରାଦୁର୍ଭାବ ମାନଚିତ୍ର 🗺️",
      realTimeOutbreak: "ଆପଣଙ୍କ ଅଞ୍ଚଳରେ ବାସ୍ତବ ସମୟରେ ରୋଗ ପ୍ରାଦୁର୍ଭାବ ମନିଟରିଂ",
      farmRecords: "ଫାର୍ମ ରେକର୍ଡ 📋",
      digitalDiary: "ଆପଣଙ୍କ ଫାର୍ମ କାର୍ଯ୍ୟକଳାପ ପାଇଁ ଡିଜିଟାଲ୍ ଡାଏରୀ",
      vaccination: "ଟୀକାକରଣ",
      treatment: "ଚିକିତ୍ସା",
      hygiene: "ସ୍ୱଚ୍ଛତା ଏବଂ ପରିମଳ ସ୍କାନର୍ 🧽",
      hygieneAssessment: "AI-ଚାଳିତ ସ୍ୱଚ୍ଛତା ମୂଲ୍ୟାଙ୍କନ ଏବଂ ସୁପାରିଶ",
      cameraScanner: "କ୍ୟାମେରା ସ୍କାନର୍",
      pointCamera: "ପାଣି ଟାଙ୍କି, ଖାଇବା ସ୍ଥାନ କିମ୍ବା ପଶୁ ଆଶ୍ରୟସ୍ଥଳରେ କ୍ୟାମେରା ଦେଖାନ୍ତୁ",
      recommendations: "ସୁପାରିଶଗୁଡିକ",
      cleanWater: "ପାଣି ଟାଙ୍କି ସଫା କରନ୍ତୁ",
      disinfectShed: "ଶେଡ୍ ବିଶୋଧନ କରନ୍ତୁ",
      pestControl: "କୀଟ ନିୟନ୍ତ୍ରଣ",
      buddyAI: "କୃଷକ ବଡି AI 🤖",
      farmingAssistant: "ଆପଣଙ୍କ ବୁଦ୍ଧିମାନ କୃଷି ସହାୟକ",
      voiceAssistant: "ଭଏସ୍ ସହାୟକ",
      tapSpeak: "କହିବା ପାଇଁ ଟାଇପ୍ କରନ୍ତୁ କିମ୍ବା ମାଇକ୍ ଉପରେ କ୍ଲିକ୍ କରନ୍ତୁ...",
      quickActions: "ଶୀଘ୍ର କାର୍ଯ୍ୟ",
      aiDailyBriefing: "AI ଦୈନିକ ସୂଚନା",
      weatherOutlook: "ପାଣିପାଗ ପୂର୍ବାନୁମାନ",
      productivityInsight: "ଉତ୍ପାଦକତା ଅନ୍ତର୍ଦୃଷ୍ଟି",
      priorityTask: "ପ୍ରାଥମିକତା କାର୍ଯ୍ୟ",
      community: "ସମ୍ପ୍ରଦାୟ",
      home: "ହୋମ୍",
      aiGreeting: "ନମସ୍କାର! ମୁଁ ପଶୁ-ରକ୍ଷକ। ମୁଁ ଆପଣଙ୍କୁ କିପରି ସାହାଯ୍ୟ କରିପାରିବି? ଆପଣ ଟାଇପ୍ କରିପାରିବେ କିମ୍ବା କହିବା ପାଇଁ ମାଇକ୍ରୋଫୋନ୍ ଉପରେ କ୍ଲିକ୍ କରିପାରିବେ।",
    }
    }
};
